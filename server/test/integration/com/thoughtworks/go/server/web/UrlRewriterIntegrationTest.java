...
public class UrlRewriterIntegrationTest {
    ...
    @DataPoint public static ResponseAssertion SSH_KEYS_PAGE = new ResponseAssertion("http://127.1.1.1:" + HTTP +"/go/admin/ssh_keys", "http://127.1.1.1:" + HTTP + "/go/rails/admin/ssh_keys", METHOD.GET);
