...
class BuildCauseRepresenterTest {
  ...
  void 'should serialize build cause'() {
        ...
        [
          ...
          "modifications": [
            [
              ...
              "revision"     : "3",
              "modified_time": getDateAsString(buildCause.getMaterialRevisions().getMaterialRevision(0).getModification(0).getModifiedTime()),
              ...
              "email_address": "foo@bar.com",
              "revision"     : "2",
              "modified_time": getDateAsString(buildCause.getMaterialRevisions().getMaterialRevision(0).getModification(1).getModifiedTime()),
              ...
              "email_address": "foo@bar.com",
              "revision"     : "1",
              "modified_time": getDateAsString(buildCause.getMaterialRevisions().getMaterialRevision(0).getModification(2).getModifiedTime()),
    ...
    new JsonOutputWriter(result, new TestRequestContext()).forTopLevelObject { writer ->
      BuildCauseRepresenter.newToJSON(writer, buildCause)
    }
